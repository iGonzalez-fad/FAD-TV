	<div id="mobile-video-search-header">
			...
			<form method="get" class="advanced-searchform-video-header" action="<?php echo esc_url($videourl); ?>">
				...
				<div id="vayvo-progression-search-mobile-button" class="noselect"><?php esc_html_e( 'More Search Filters', 'vayvo-progression' ); ?> <i class="fa fa-angle-down"></i></div>
					...
					<div id="video-search-header-filtering-padding">
						...
						<ul class="skrn-video-search-columns skrn-video-search-count-<?php echo esc_attr( get_theme_mod( 'progression_studios_header_search_columns', '4') ); ?>">
							...
							<?php $vcategory = get_terms('video-category'); if($vcategory): ?>
								<li class="column-search-header">
									<h5><?php esc_html_e( 'Category:', 'vayvo-progression' ); ?></h5>
						...
						<div class="video-search-header-buttons">
							...
							<input type="button" id="mobile-configure-rest" value="<?php echo esc_html__( 'Reset', 'vayvo-progression' ); ?>" />
						</div>
