	...
	class Frontend_WP_Elementor{
		...
		public function widget_categories( $elements_manager ) {
			$categories = array(
				...
				/* 'frontend-admin-lists' => array(
					'title' => __( 'FRONTEND LISTS', FEA_NS ),
					'icon' => 'fa fa-plug',
				), */
			);
			...
			if ( fea_instance()->is__premium_only() ) {
				$categories['frontend-admin-products'] = array(
					'title' => __( 'FRONTEND PRODUCTS', FEA_NS ),
					'icon' => 'fa fa-plug',
				);
			}
		...
		public function editor_scripts(){
			...
			wp_enqueue_style( 'fea-icon', FEA_URL . 'assets/css/icon.css', array(), FEA_VERSION );
