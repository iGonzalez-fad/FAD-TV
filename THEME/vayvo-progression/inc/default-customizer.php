...
function progression_studios_customizer( $wp_customize ) {
   ...
   /* Section - Blog - Blog Index Post Options */
	...
	$wp_customize->add_control(new progression_studios_Controls_Radio_Buttonset_Control($wp_customize, 'progression_studios_video_search_filters_mobile', array(
		...
		'section'  => 'progression-studios-dashboard-search',
		'priority'   => 10,
		'choices' => array(
	...
	*/
    ...
    /* Section - Blog - Blog Index Post Options */
 	...
 	$wp_customize->add_control( 'progression_studios_blog_pagination', array(
		...
		'section' => 'progression-studios-video-index-options',
 		'type' => 'select',
 		'priority'   => 3,
 		'choices' => array(
 			'default' => esc_html__( 'Default', 'vayvo-progression' ),
   ...
   /* Section - Blog - Blog Index Post Options */
    ...
    /* Section - Blog - Blog Index Post Options */
 	$wp_customize->add_setting( 'progression_studios_seasons_deprecation' ,array(
 		'default' => 'default',
 		'sanitize_callback' => 'progression_studios_sanitize_choices',
 	) );
 	$wp_customize->add_control(new progression_studios_Controls_Radio_Buttonset_Control($wp_customize, 'progression_studios_seasons_deprecation', array(
 		'label'    => esc_html__( 'Seasons', 'vayvo-progression' ),
 		'section' => 'progression-studios-video-post-options',
 		'priority'   => 2,
 		'choices' => array(
 			'default' => esc_html__( 'Unlimited', 'vayvo-progression' ),
 			'false' => esc_html__( 'Deprecated/Old', 'vayvo-progression' ),
		
 		 ),
 		))
 	);
	
 	/* Setting - Video - Videos Main */
	$wp_customize->add_setting( 'progression_studios_episode_link' ,array(
		'default' => 'default',
		'sanitize_callback' => 'progression_studios_sanitize_choices',
	) );
	$wp_customize->add_control(new progression_studios_Controls_Radio_Buttonset_Control($wp_customize, 'progression_studios_episode_link', array(
		'label'    => esc_attr__( 'Episode Links', 'vayvo-progression' ),
 		'section' => 'progression-studios-video-post-options',
		'priority'   => 3,
		'choices'     => array(
			'default' => esc_attr__( 'Open in Lightbox', 'vayvo-progression' ),
			'post_link' => esc_attr__( 'Link to Post', 'vayvo-progression' ),
		),
		))
	);
