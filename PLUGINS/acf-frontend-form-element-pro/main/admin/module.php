...
if( ! class_exists( 'Frontend_WP_Admin' ) ) :
	...
	class Frontend_WP_Admin{
		...
		public function plugin_page() {
			...
			$frontend_admin_settings = add_menu_page( FEA_TITLE, FEA_TITLE, 'manage_options', FEA_PRE.'-settings', [ $this, 'admin_settings_page'], 'dashicons-feedback', '87.87778' );
		...
		public function scripts(){
			...
			wp_register_style( 'fea-public', FEA_URL . 'assets/css/frontend-admin'.$min.'.css', array(), FEA_VERSION );	
			...
			if ( fea_instance()->is__premium_only() ) {
				...
				wp_register_script( 'fea-public-pro', FEA_URL . 'assets/js/pro/frontend-admin-pro'.$min.'.js', array( 'jquery', 'acf', 'acf-input', 'fea-public' ), FEA_VERSION, true );
			}
