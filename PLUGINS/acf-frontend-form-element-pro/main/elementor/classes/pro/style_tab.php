...
class StyleTab{
	...
	public function style_tab_settings( $widget ){
		...
		$widget->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .frontend-form-title' => 'justify-content: {{VALUE}}',
				],
			]
		);
		...
		$widget->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .frontend-form-title',
			]
		);
		...
		$widget->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .frontend-form-title' => 'fill: {{VALUE}}; color: {{VALUE}};',
				],
			]
		);
	...
	public function submit_button_styles( $widget ){
		...
		$widget->start_controls_section(
			...
			[
				'label' => __( 'Submit Button', 'acf-frontend-form-elements' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
