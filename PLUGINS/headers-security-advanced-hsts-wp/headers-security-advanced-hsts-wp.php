...
Author URI: https://www.linkedin.com/in/andrea-ferro-55046186/                                                                                
 ___  ________  ________  ________   ________          ________  ________   ________          ________  ___  ___  ________     
|\  \|\   __  \|\   __  \|\   ___  \|\_____  \        |\   __  \|\   ___  \|\   ___ \        |\   ____\|\  \|\  \|\_____  \    
\ \  \ \  \|\  \ \  \|\  \ \  \\ \  \|____|\ /_       \ \  \|\  \ \  \\ \  \ \  \_|\ \       \ \  \___|\ \  \\\  \\|___/  /|   
 \ \  \ \   _  _\ \  \\\  \ \  \\ \  \    \|\  \       \ \   __  \ \  \\ \  \ \  \ \\ \       \ \  \  __\ \  \\\  \   /  / /   
  \ \  \ \  \\  \\ \  \\\  \ \  \\ \  \  __\_\  \       \ \  \ \  \ \  \\ \  \ \  \_\\ \       \ \  \|\  \ \  \\\  \ /  /_/__  
   \ \__\ \__\\ _\\ \_______\ \__\\ \__\|\_______\       \ \__\ \__\ \__\\ \__\ \_______\       \ \_______\ \_______\\________\
    \|__|\|__|\|__|\|_______|\|__| \|__|\|_______|        \|__|\|__|\|__| \|__|\|_______|        \|_______|\|_______|\|_______|
...
function add_Headers_Security_Advanced_HSTS_WP_htaccess( $rules ) {
  ...
  $content = <<<EOD
  # Headers Security Advanced & HSTS WP - 4.8.92
  ...
  Header set X-Powered-By "$HEadersSecurityAdvancedServerCheck3B"
...
function Headers_Security_Advanced_HSTS_WP_widget_function() {
  // $HEadersSecurityAdvancedServerCheckWidget = $_SERVER['SERVER_NAME'];
  // $HEadersSecurityAdvancedCheckWidgetUp = str_replace('www.','',$HEadersSecurityAdvancedServerCheckWidget);
...
function Headers_Security_Advanced_HSTS_WP_Headers( $headers ) {
  ...
  $headers['X-Powered-By'] = "$HEadersSecurityAdvancedServerCheck3";
...
if ( ! defined( 'headers-security-advanced-hsts-wp-base-uri' ) ) {
  ...
  function csrf_Headers_Security_Advanced_HSTS_WP_options() {
    // $HEadersSecurityAdvancedServerCheckWidgetPage = $_SERVER['SERVER_NAME'];
    // $HEadersSecurityAdvancedCheckWidgetUpPage = str_replace('www.','',$HEadersSecurityAdvancedServerCheckWidgetPage);
